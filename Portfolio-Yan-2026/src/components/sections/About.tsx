...
const timeline: TimelineItem[] = [
  {
    ...
    year: "2021",
    tech: "Node.js",
    description: "Comecei com backend JavaScript",
  },
  {
    id: 2,
    year: "2022",
                  ...
                  >
                    ...
                    <div className="ml-8 md:ml-0 p-6 bg-card rounded-lg border border-gray-700 hover:border-cyan-500 transition-colors duration-300">
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        <span className="px-3 py-1 text-sm font-semibold text-whiteText bg-linear-to-r from-cyan-500 to-green-500 rounded-full">
                          {item.tech}
                        </span>
                      </div>
